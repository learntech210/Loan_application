...
import os
filepath = '/Users/hsbc/Downloads/loan99/logistic_loan.pkl'
if os.path.exists(filepath):
    file = open('/Users/hsbc/Downloads/loan99/logistic_loan.pkl', 'rb')
...
def ValuePredictor(to_predict_list):
    ...
    loaded_model = pickle.load(open("logistic_loan.pkl", "rb"))
